    ...
    return (
        <div>
            <div className='mx-auto lg:ml-0 mt-2'>
                <footer className="footer footer-center p-10 bg-black text-primary-content shadow-inner shadow-zinc-600 ">
                    <div>
                        ...
                        Memorable Journeys is a trusted tourist service since 2001
                        </p>
