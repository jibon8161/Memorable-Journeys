...
const Footer = () => {
    return (
        <div>
            <div className='mx-auto lg:ml-0 mt-2'>
                <footer className="footer footer-center p-10 bg-black text-orange-500 shadow-inner shadow-zinc-600 ">
                    <div>
                        ...
                        Memorable Journeys Your personal tour guide <br />
                        Energetic professional with 4 years of experience informing and guiding museum visitors. Superior talent for entertaining audience members and delivering a high level of customer service. Extensive knowledge of history and visual arts; able to learn, retain, and recall extensive amounts of information quickly
                        </p>
